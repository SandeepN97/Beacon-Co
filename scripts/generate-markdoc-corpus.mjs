...
const gettingStarted = [
  [
    "overview",
    "Overview",
    "How to read and use the Beacon source of truth.",
    `
...
`,
  ...
  [
    "repository-guide",
    "Repository guide",
    "Where implementation, documentation, orchestration, and evidence live.",
    `
## Primary paths
...
`,
  ...
  [
    "local-development",
    "Local development",
    "Install, run, test, and build the repository locally.",
    `
## Prerequisites
...
`,
  ...
  [
    "documentation-guide",
    "Documentation guide",
    "How to author, review, link, and validate canonical Markdoc pages.",
    `
## Authoring contract
...
gettingStarted.forEach(([slug, title, description, body], index) =>
  add(
    `getting-started/${slug}`,
    {
      ...
      truthState: "current",
      sourceFiles: ["BEACON_COMPLETE_EXECUTION_PROMPT.md", "AGENTS.md", "package.json"],
      relatedAdrs: ["0006-use-markdoc", "0013-use-docs-as-code"],
      relatedPages: ["references/document-statuses"],
...
const productPages = [
  [
    ...
    "Why Beacon exists, who it serves, and what outcome the system must support.",
    `
...
`,
  ...
  [
    ...
    "Problem and outcomes",
    "The user problem, company outcome, and evidence boundaries.",
    `
## Customer problem
...
`,
  ...
  [
    ...
    "The brand, CTA, imagery, accessibility, and motion rules all surfaces preserve.",
    `
## Experience rules
...
`,
  ...
  [
    ...
    "Names that keep roles, providers, state, and truth boundaries precise.",
    `
| Term | Meaning |
|---|---|
...
`,
  ...
  [
    "scope-and-non-goals",
    "Scope and non-goals",
    "What this implementation includes and what remains intentionally absent.",
    `
## In scope
...
productPages.forEach(([slug, title, description, body], index) =>
  add(
    `product/${slug}`,
    {
      ...
      description,
      section: "product",
      order: sectionOrder.product + index,
      truthState: slug === "scope-and-non-goals" ? "current" : "decision",
      sourceFiles:
        slug === "vision"
          ? [
              "docs/decisions/0001-why-beacon-exists-and-business-definition.md",
              "docs/business/plan.md",
              "src/components/PricingCards.astro",
            ]
          : [
              "docs/decisions/0002-define-brand-and-customer-experience.md",
              "BEACON_COMPLETE_EXECUTION_PROMPT.md",
            ],
      relatedAdrs: [
        "0001-why-beacon-exists-and-business-definition",
      ...
      relatedPages: ["plans/current-phase"],
      tags: ["product"],
    },
    body,
  ),
...
const planPages = [
  [
    "roadmap",
    "Roadmap",
    "Phase-based capability sequence without invented dates, budgets, or completion percentages.",
    `
## Completed
...
`,
  ...
  [
    "current-phase",
    "Current phase",
    "Verified repository state and explicit target boundaries.",
    `
...
`,
  ...
  [
    ...
    "Evidence-based exit gates for growing from documentation to controlled orchestration.",
    `
...
`,
  ...
  [
    "capability-map",
    "Capability map",
    "Current, simulated, proposed, and future capabilities in one map.",
    `
...
`,
  ...
  [
    "future-work",
    "Future work",
    "Unimplemented capabilities that require a new bounded decision and authorization.",
    `
## Next safe work
...
planPages.forEach(([slug, title, description, body], index) =>
  add(
    `plans/${slug}`,
    {
      ...
      description,
      section: "plans",
      order: sectionOrder.plans + index,
      ...
      relatedAdrs: [
        "0003-record-architecture-evolution-and-source-atlas",
        "0007-use-central-broker",
      ],
      relatedPages: ["architecture/overview"],
      tags: ["roadmap", "phase"],
    },
    body,
  ),
...
const architecturePages = [
  [
    "overview",
    "Architecture overview",
    "Current Astro application, canonical Markdoc, and separate orchestration module.",
    `
...
`,
  ...
  [
    "system-context",
    "System context",
    "People, canonical knowledge, control plane, worker plane, and external boundaries.",
    `
## Context
...
`,
  ...
  [
    "company-structure",
    "Company structure",
    "Stable departments and roles with dynamic model assignment.",
    `
## Company lanes
...
`,
  ...
  [
    "broker-control-plane",
    "Broker control plane",
    "Deterministic management responsibilities above provider workers.",
    `
## Responsibilities
...
`,
  ...
  [
    "worker-plane",
    "Worker plane",
    "Claude and Codex as bounded, replaceable role executors.",
    `
## Worker contract
...
`,
  ...
  [
    "broker-components",
    "Broker components",
    "Queue, router, registry, packager, execution, gates, review, audit, and approval services.",
    `
...
`,
  ...
  [
    "work-unit-contract",
    "Work-unit contract",
    "The validated package that crosses translator, broker, provider, review, and continuation boundaries.",
    `
## Required contract
...
`,
  ...
  [
    ...
    "Routing and scheduling",
    "Policy-first, capability-aware, Claude-first routing with Codex affinity and fallback.",
    `
## Decision order
...
`,
  ...
  [
    "data-and-state",
    "Data and state",
    "Why Markdoc stores approved knowledge while runtime stores execution state.",
    `
## Markdoc stores
...
`,
  ...
  [
    "security-boundaries",
    "Security boundaries",
    "Least privilege, data policy, provider eligibility, worktree isolation, and human authority.",
    `
## Boundaries
...
`,
  ...
  [
    ...
    "Observability and audit",
    "Evidence that makes routing, provider changes, gates, approvals, and outcomes traceable.",
    `
## Required evidence
...
`,
  ...
  [
    ...
    "Current static deployment shape and future orchestration separation.",
    `
## Current
...
`,
  ...
  [
    "diagrams",
    "Diagram catalog",
    "Purpose, source, level, status, preview, and textual alternative for every supplied architecture scene.",
    `
## Supplied sources
...
architecturePages.forEach(([slug, title, description, body], index) =>
  add(
    `architecture/${slug}`,
    {
      ...
      order: sectionOrder.architecture + index,
      truthState: ["overview", "deployment"].includes(slug) ? "current" : "target",
      sourceFiles: architectureSources,
      relatedAdrs: [
        "0003-record-architecture-evolution-and-source-atlas",
        "0007-use-central-broker",
        "0008-stable-roles-dynamic-models",
        "0014-use-provider-adapter-boundary",
      ],
      relatedPages: ["plans/capability-map", "references/source-map"],
      tags: ["architecture", "broker"],
    },
    body,
  ),
);
...
const agents = [
  {
    slug: "chief-of-staff",
    name: "Chief of Staff",
    lane: "Leadership and intake",
    responsibility:
      "Clarify the request, select the business workflow, verify handoffs, and stop at approval gates.",
  ...
  },
  {
    ...
    lane: "Leadership and delivery coordination",
    responsibility:
      "Create milestones, dependencies, ownership, risk logs, and reviewable work units.",
  ...
  },
  {
    ...
    responsibility:
      "Validate customer problems, demand, alternatives, competitors, and evidence gaps.",
  ...
  },
  {
    ...
    lane: "Business discovery",
    responsibility:
      "Convert approved business needs into complete, testable requirements without designing the solution.",
  ...
  },
  {
    ...
    lane: "Product and design",
    responsibility:
      "Define product value, MVP scope, priority, success metrics, and deferred work.",
  ...
  },
  {
    ...
    lane: "Architecture and security",
    responsibility:
      "Design components, APIs, data flow, reliability, deployment, trade-offs, and implementation sequence.",
  ...
  },
  {
    ...
    lane: "Architecture and security",
    responsibility:
      "Create threat scenarios, security controls, abuse cases, and security acceptance criteria.",
  ...
  },
  {
    ...
    lane: "Engineering",
    responsibility:
      "Trace current behavior, dependencies, conventions, and safe change points without editing.",
  ...
  },
  {
    ...
    lane: "Quality",
    responsibility:
      "Independently test implementation against acceptance criteria and regression risk.",
  ...
  },
  {
    ...
    lane: "Quality",
    responsibility:
      "Review the final diff for correctness, security, maintainability, performance, and requirement coverage.",
  ...
  },
  {
    ...
    lane: "Delivery",
    responsibility:
      "Prepare approved CI/CD, environment, migration, rollback, monitoring, and alert artifacts.",
  ...
  },
  {
    ...
    lane: "Delivery",
    responsibility:
      "Verify business, quality, security, operational, migration, documentation, and rollback readiness.",
...
add(
  "agents/overview",
  {
    ...
    description: "Stable roles, dynamic providers, one deliverable owner, and independent review.",
    section: "agents",
    order: sectionOrder.agents,
    truthState: "target",
    sourceFiles: architectureSources,
    relatedAdrs: ["0008-stable-roles-dynamic-models", "0009-require-independent-second-voice"],
    relatedPages: ["agents/universal-agent-contract", "workflows/end-to-end-business-workflow"],
    tags: ["agents", "roles"],
  },
  `
## Core organization
...
add(
  "agents/universal-agent-contract",
  {
    title: "Universal agent contract",
    description:
      "The minimum input, responsibility, permission, output, evidence, and stop contract for every role.",
    section: "agents",
    order: sectionOrder.agents + 1,
    truthState: "decision",
    sourceFiles: coreSources,
    relatedAdrs: ["0008-stable-roles-dynamic-models"],
    relatedPages: ["agents/universal-handoff"],
...
add(
  "agents/universal-handoff",
  {
    title: "Universal handoff",
    description:
      "The fixed provider-neutral record that lets the next role continue without reinterpretation.",
    section: "agents",
    order: sectionOrder.agents + 2,
    truthState: "decision",
    sourceFiles: coreSources,
    relatedAdrs: ["0008-stable-roles-dynamic-models", "0014-use-provider-adapter-boundary"],
    relatedPages: ["architecture/work-unit-contract"],
    tags: ["agents", "handoff"],
  },
  `
## Required fields
...
agents.forEach((agent, index) =>
  add(
    `agents/${agent.slug}`,
    {
      ...
      section: "agents",
      order: sectionOrder.agents + 10 + index,
      truthState: "target",
      sourceFiles: [
        "reference/source-materials/originals/Claude_Multi_Agent_Business_Guide.pdf",
        "reference/source-materials/originals/individual_agent_architecture_animated.excalidraw",
      ...
      relatedAdrs: ["0008-stable-roles-dynamic-models", "0009-require-independent-second-voice"],
      relatedPages: ["agents/universal-agent-contract", "agents/universal-handoff"],
      tags: ["agent", agent.lane.toLowerCase()],
    },
    `
## Purpose
...
add(
  "agents/business-growth-agents",
  {
    title: "Business growth agent blueprints",
    description: "Optional strategy, finance, marketing, sales, content, and customer roles.",
    section: "agents",
    order: sectionOrder.agents + 30,
    truthState: "proposal",
    sourceFiles: ["reference/source-materials/originals/Claude_Multi_Agent_Business_Guide.pdf"],
    relatedAdrs: ["0008-stable-roles-dynamic-models"],
    relatedPages: ["agents/universal-agent-contract"],
    tags: ["agents", "growth"],
  },
  `
## Optional roles
...
add(
  "agents/advanced-operations-agents",
  {
    title: "Advanced operations agent blueprints",
    description: "Optional compliance, reliability, incident, knowledge, cost, and vendor roles.",
    section: "agents",
    order: sectionOrder.agents + 31,
    truthState: "proposal",
    sourceFiles: ["reference/source-materials/originals/Claude_Multi_Agent_Business_Guide.pdf"],
    relatedAdrs: ["0008-stable-roles-dynamic-models"],
    relatedPages: ["operations/operating-model"],
...
const workflowPages = [
  [
    "overview",
    "Workflow overview",
    "Sequential role ownership, provider routing, deterministic gates, repair, and human authority.",
    `
...
`,
  ...
  [
    ...
    "End-to-end business workflow",
    "The 15 controlled phases from idea intake through operations learning.",
    `
${[
  ...
  .map(
    ([title, owner], i) =>
      `{% workflow_step number=${i + 1} title="${title}" owner="${owner}" %}\nOne approved deliverable and universal handoff controls entry to the next stage.\n{% /workflow_step %}`,
  )
  .join("\n\n")}
`,
  ],
  [
    "broker-work-unit-lifecycle",
    "Broker work-unit lifecycle",
    "Draft, context, approval, routing, execution, review, repair, and completion states.",
    `
\`\`\`text
draft
→ waiting-for-context
...
`,
  ...
  [
    "planning-and-second-voice",
    "Planning and second voice",
    "A primary planner owns the plan and the other provider independently challenges it.",
    `
...
`,
  ...
  [
    ...
    "Implementation and diff review",
    "Smallest-change implementation followed by a read-only review from the other provider.",
    `
...
`,
  ...
  [
    ...
    "Real commands and acceptance evidence remain authoritative over model confidence.",
    `
...
`,
  ...
  [
    ...
    "Majority convergence",
    "The 2-of-3 panel policy with independence, blockers, evidence, and human gates.",
    `
## Completion rule
...
`,
  ...
  [
    "bounded-repair-loop",
    "Bounded repair loop",
    "How evidence returns a defect to the role that owns it.",
    `
...
`,
  ...
  [
    "human-approval-flow",
    "Human approval flow",
    "How consequential actions pause until an authorized person decides.",
    `
...
`,
  ...
  [
    "release-flow",
    "Release flow",
    "Evidence assembly, hold/release recommendation, human decision, and post-release validation.",
    `
...
`,
  ...
  [
    ...
    "How support, reliability, customer outcomes, quality, and cost become new controlled work.",
    `
...
workflowPages.forEach(([slug, title, description, body], index) =>
  add(
    `workflows/${slug}`,
    {
      ...
      description,
      section: "workflows",
      order: sectionOrder.workflows + index,
      truthState: "target",
      sourceFiles: coreSources,
      relatedAdrs: [
        "0009-require-independent-second-voice",
        "0010-use-deterministic-quality-gates",
        "0012-require-human-approval",
      ],
      relatedPages: ["agents/overview", "architecture/broker-control-plane"],
      tags: ["workflow"],
    },
    body,
  ),
...
const governancePages = [
  [
    ...
    "Permissions and least privilege",
    "Read-only defaults, controlled write boundaries, and forbidden external actions.",
    `
...
`,
  ...
  [
    "model-independence",
    "Model independence",
    "Why roles and business meaning stay stable when Claude or Codex changes.",
    `
...
`,
  ...
  [
    "capacity-and-cost-routing",
    "Capacity and cost routing",
    "Observed health, cooldown, load, quality, and manual capacity without fabricated allowances.",
    `
...
`,
  ...
  [
    ...
    "Privacy and data classification",
    "Public, internal, confidential, and restricted request handling.",
    `
...
`,
  ...
  [
    "evidence-policy",
    "Evidence policy",
    "What must be cited before a decision, review, gate, or completion claim is valid.",
    `
...
`,
  ...
  [
    "audit-policy",
    "Audit policy",
    "The minimum event trail for translation, routing, execution, review, approval, and impact.",
    `
...
`,
  ...
  [
    "human-authority",
    "Human authority",
    "Decisions the owner, authorized professionals, and clients retain.",
    `
...
governancePages.forEach(([slug, title, description, body], index) =>
  add(
    `governance/${slug}`,
    {
      ...
      description,
      section: "governance",
      order: sectionOrder.governance + index,
      truthState: "decision",
      sourceFiles: coreSources,
      relatedAdrs: [
        "0008-stable-roles-dynamic-models",
      ...
      relatedPages: ["architecture/security-boundaries"],
      tags: ["governance"],
    },
    body,
  ),
...
const adrs = [
  {
    ...
    number: "ADR-0001",
    title: "Why Beacon exists and the business definition",
    status: "approved",
    truth: "decision",
    context:
      "Strong local businesses can be difficult to find online, and a solo operator needs a bounded, credible entry rather than a speculative platform.",
    drivers: [
      "Useful local outcome",
      "Transparent small first engagement",
      "Founder and client authority",
      "Manual learning before automation",
    ],
    options: [
      "Build a broad agency first",
      "Build an automation platform first",
      "Start with one local presence and a product ladder",
    ],
    decision:
      "Operate Beacon & Co. as a solo digital-presence service around Waynesboro. Begin with a free audit and the smallest fitting paid service. Preserve the founder sales call and client content approval.",
    positive: [
      "Starts from a real customer problem",
      "Constrains architecture to current value",
      "Makes ownership and pricing legible",
    ],
    negative: ["Founder remains a bottleneck", "Pricing and economics require operating evidence"],
    risks: [
      "Brand/name clearance remains open",
      "Market and margin claims may age",
      "Low pricing may not support actual time",
    ],
    follow: [
      "Measure time and costs by offer",
      "Complete formal name/domain diligence",
      "Revalidate claims before public use",
    ],
  ...
  },
  {
    ...
    number: "ADR-0002",
    title: "Define the brand and customer experience",
    status: "approved",
    truth: "decision",
    context:
      "Beacon must earn local trust without loud agency claims or an impersonal software aesthetic.",
    drivers: [
    ...
    options: [
      "Generic software theme",
      "High-stimulation agency design",
      "Restrained editorial Beacon system",
    ],
    decision:
      "Use the forest, sage, gold, cream, ink, and rule palette; Playfair and DM Sans hierarchy; one primary CTA; real photography; visible focus; reduced motion; and honest status language.",
    ...
    sources: [
      "docs/decisions/0002-define-brand-and-customer-experience.md",
      "docs/brand.md",
      "docs/product/experience-specification.md",
    ],
  },
  {
    slug: "0003-record-architecture-evolution-and-source-atlas",
    number: "ADR-0003",
    title: "Record architecture evolution and source atlas",
    status: "approved",
    truth: "decision",
    context:
      "Beacon grew from one page to a maintainable site and then a documented target platform. Diagrams must not turn future systems into fictional current state.",
    drivers: [
      "Phase truth",
      "Smallest safe current architecture",
      "Editable sources",
      "Accessible alternatives",
    ],
    options: [
      "One undifferentiated target diagram",
      "No architecture record",
      "Phase-gated narrative plus Mermaid/Excalidraw",
    ],
    decision:
      "Keep current and target boundaries explicit. Maintain decision narrative, text diagrams, editable Excalidraw sources, previews, and textual alternatives.",
    ...
    follow: [
      "Update the catalog with every material architecture change",
      "Revalidate vendor choices at phase entry",
    ],
    supersedes: "Consolidates prior architecture records; superseded by: none.",
    sources: [
      "docs/decisions/0003-record-architecture-evolution-and-source-atlas.md",
      ...architectureSources,
    ],
  },
  {
    ...
    number: "ADR-0004",
    title: "Use a durable AI-assisted operating model",
    status: "superseded",
    truth: "decision",
    context:
      "Claude and Codex sessions can end or hit capacity, so repository memory must outlive either tool.",
    ...
    follow: [
      "Retain compact handoffs",
      "Use ADR-0007 for the approved in-repository simulation boundary",
    ],
    supersedes: "Superseded in part by ADR-0007. Repository-first memory remains valid.",
    sources: [
      "docs/decisions/0004-use-a-durable-ai-assisted-operating-model.md",
  ...
  },
  {
    ...
    number: "ADR-0005",
    title: "Use Astro for the unified marketing, docs, and workspace site",
    status: "approved",
    truth: "decision",
    context:
      "The repository already uses Astro static output and must not be replaced with a generic docs starter.",
    drivers: [
      "Preserve current app",
      "Static Cloudflare compatibility",
      "No client framework runtime",
      "One build",
    ],
    options: [
      "Separate docs repository",
      "Replace marketing app",
      "Add docs/workspace routes to Astro",
    ],
    decision:
      "Keep one Astro static application with marketing at /, documentation at /docs, and simulation at /workspace.",
  ...
  },
  {
    ...
    number: "ADR-0006",
    title: "Use Markdoc as canonical documentation source",
    status: "approved",
    truth: "decision",
    context:
      "Project memory needs typed metadata, reusable components, source control, and retrieval by the orchestration module.",
    drivers: [
      "Content validation",
      "Astro integration",
    ...
    options: [
      "Retain MkDocs as canonical",
      "Plain Markdown pages",
      "Astro content collection with Markdoc",
    ],
    decision:
      "Use .mdoc content entries, a strict Astro collection schema, controlled tags, and unsafe HTML disabled.",
    ...
    follow: [
      "Label Markdoc canonical in all entry points",
      "Remove legacy MkDocs only in a separately approved cleanup",
    ],
  ...
  },
  {
    ...
    number: "ADR-0007",
    title: "Use a central broker boundary",
    status: "approved",
    truth: "decision",
    context:
      "Provider switching, policy, evidence, and completion cannot safely live inside ad hoc prompts or Astro pages.",
    drivers: [
      "Provider neutrality",
      "Policy enforcement",
      "Continuation",
    ...
    options: [
      "Direct page-to-provider calls",
      "Prompt-only routing",
      "Separate internal orchestration module",
    ],
    decision:
      "Implement a separate in-repository broker module as an in-memory simulation. Durable service extraction and live invocation remain future decisions.",
    ...
    supersedes:
      "Supersedes ADR-0004’s blanket no-broker clause while preserving file-based continuity.",
  ...
  },
  {
    ...
    number: "ADR-0008",
    title: "Keep roles stable and assign models dynamically",
    status: "approved",
    truth: "decision",
    context:
      "Claude and Codex can perform overlapping work, while company responsibility must remain clear.",
    drivers: [
      "One deliverable owner",
      "Provider replacement",
      "Capacity fallback",
      "Measured affinity",
    ],
    options: [
      "Claude architecture/Codex coding permanently",
      "Unstructured free-for-all",
      "Stable roles with broker assignment",
    ],
    decision:
      "Define role contracts independently of providers. Assign Claude or Codex per work unit using policy, capability, preference, health, capacity, context, and affinity.",
  ...
  },
  {
    ...
    number: "ADR-0009",
    title: "Require an independent second voice",
    status: "approved",
    truth: "decision",
    context:
      "An authoring model or session has correlated blind spots and cannot independently approve itself.",
    drivers: ["Reviewer independence", "Defect discovery", "Evidence-based convergence"],
    options: [
      "Self-review",
      "Same provider/session review",
      "Other provider plus fresh-session panel",
    ],
    decision:
      "Use the other eligible provider for critique and exclude the authoring session from approval votes.",
  ...
  },
  {
    ...
    number: "ADR-0010",
    title: "Use deterministic quality gates before model judgment",
    status: "approved",
    truth: "decision",
    context:
      "Confident review cannot prove that code builds, tests pass, or security checks succeed.",
    drivers: ["Reproducibility", "Blocking failures", "Acceptance evidence"],
    options: [
      "Model-only approval",
      "Optional commands",
      "Mandatory applicable commands before voting",
    ],
    decision:
      "Run real applicable repository commands before review convergence. A failed blocking gate cannot be outvoted.",
  ...
  },
  {
    ...
    number: "ADR-0011",
    title: "Use isolated Git worktrees for live implementation workers",
    status: "draft",
    truth: "proposal",
    ...
    decision:
      "Proposed: when live execution is authorized, assign one validated worktree per work unit. No worktree executor exists now.",
    ...
    follow: [
      ...
      "Build a dry-run lifecycle",
      "Require explicit cleanup policy",
    ],
  ...
  },
  {
    ...
    truth: "decision",
    context:
      "Models may organize evidence but do not own legal, financial, production, or business authority.",
    ...
    decision:
      "Pause material architecture, spending, legal/privacy, production, merge, deployment, and release until an authorized human records a scoped decision.",
  ...
  },
  {
    ...
    number: "ADR-0013",
    title: "Use docs as code for canonical project memory",
    status: "approved",
    truth: "decision",
    ...
    decision:
      "Store approved business, architecture, decisions, contracts, workflows, and runbooks in Markdoc. Propose all updates through repository review.",
  ...
  },
  {
    ...
    number: "ADR-0014",
    title: "Use a provider adapter boundary",
    status: "approved",
    truth: "decision",
    context:
      "Claude and Codex need tool-specific formatting without changing the approved request.",
    drivers: ["Same business meaning", "Replaceability", "Fallback", "Testability"],
    options: [
      "Provider-specific requests",
      "Direct broker CLI logic",
      "Shared request with adapters",
    ],
    decision:
      "Compile provider-specific prompts from the same work request and context package. Adapters cannot alter criteria, approvals, or business meaning.",
    ...
    sources: [
      "BEACON_COMPLETE_EXECUTION_PROMPT.md",
      "src/modules/orchestration/providers/provider-adapter.ts",
    ],
  },
];
...
add(
  "decisions/index",
  {
    title: "Decision book",
    description:
      "Business, experience, architecture, documentation, orchestration, and governance decisions in dependency order.",
    section: "decisions",
    order: sectionOrder.decisions,
    truthState: "decision",
    sourceFiles: ["docs/decisions/index.md", "BEACON_COMPLETE_EXECUTION_PROMPT.md"],
    relatedAdrs: [],
    relatedPages: ["decisions/adr-template"],
    tags: ["adr", "decisions"],
  },
  `
## Foundation
...
add(
  ...
  {
    title: "ADR template",
    description: "Required one-decision structure and truthful status guidance.",
    section: "decisions",
    order: sectionOrder.decisions + 1,
    truthState: "reference",
    sourceFiles: ["BEACON_COMPLETE_EXECUTION_PROMPT.md"],
    relatedAdrs: [],
    relatedPages: ["governance/evidence-policy"],
    tags: ["adr", "template"],
  },
  `
## Template
...
adrs.forEach((adr, index) =>
  add(
    `decisions/${adr.slug}`,
    {
      ...
      section: "decisions",
      order: sectionOrder.decisions + 10 + index,
      status: adr.status,
      truthState: adr.truth,
      sourceFiles: adr.sources,
      relatedAdrs: [],
      relatedPages: ["decisions/index"],
      tags: ["adr", adr.status],
    },
    `
...
const operationsPages = [
  [
    "operating-model",
    "Operating model",
    "How the controlled company runs one role, one phase, and one evidence-backed handoff at a time.",
    `
...
`,
  ...
  [
    "configuration",
    "Configuration",
    "Claude-first preference, task affinity, provider profiles, workflow limits, and simulation settings.",
    `
...
`,
  ...
  [
    ...
    "Model health and cooldowns",
    "Observed failure, degradation, rate limits, manual capacity, and recovery.",
    `
...
`,
  ...
  [
    "monitoring",
    "Monitoring",
    "Target signals for provider, workflow, quality, cost, and business outcomes.",
    `
...
`,
  ...
  [
    "incident-response",
    "Incident response",
    "Target detection, containment, recovery, communication, and learning flow.",
    `
...
`,
  ...
  [
    "backup-and-recovery",
    "Backup and recovery",
    "Current repository recovery and future runtime-state requirements.",
    `
...
`,
  ...
  [
    "release-runbook",
    "Release runbook",
    "Evidence and authority required before any future merge, deployment, or release.",
    `
...
operationsPages.forEach(([slug, title, description, body], index) =>
  add(
    `operations/${slug}`,
    {
      ...
      description,
      section: "operations",
      order: sectionOrder.operations + index,
      truthState: ["configuration", "model-health-and-cooldowns"].includes(slug)
        ? "current"
        : "target",
      sourceFiles: coreSources,
      relatedAdrs: [
      ...
      relatedPages: ["workflows/operations-learning-loop"],
      tags: ["operations"],
    },
    body,
  ),
...
add(
  "references/source-map",
  {
    title: "Source map",
    description:
      "Authority, provenance, extraction, and conflict rules for project claims and diagrams.",
    section: "references",
    order: sectionOrder.references,
    truthState: "current",
    sourceFiles: [
    ...
    relatedPages: ["references/open-questions", "architecture/diagrams"],
...
add(
  "references/document-statuses",
  {
    title: "Document statuses",
    description: "Approved lifecycle and truth-state labels for canonical documentation.",
    section: "references",
    order: sectionOrder.references + 1,
    truthState: "reference",
    sourceFiles: ["BEACON_COMPLETE_EXECUTION_PROMPT.md"],
    relatedAdrs: ["0013-use-docs-as-code"],
    relatedPages: ["getting-started/documentation-guide"],
    tags: ["status"],
  },
  `
| Status | Meaning |
...
add(
  "references/glossary",
  {
    title: "Glossary",
    description:
      "Shared business, documentation, orchestration, provider, and evidence vocabulary.",
    section: "references",
    order: sectionOrder.references + 2,
    truthState: "reference",
    sourceFiles: coreSources,
    relatedAdrs: ["0008-stable-roles-dynamic-models"],
    relatedPages: ["product/terminology"],
    tags: ["glossary"],
  },
  `
...
add(
  ...
  {
    title: "Open questions and source conflicts",
    description:
      "Unresolved decisions, source tensions, and migration needs that must not be silently assumed.",
    section: "references",
    order: sectionOrder.references + 3,
    status: "under-review",
    truthState: "reference",
    sourceFiles: [
      "BEACON_COMPLETE_EXECUTION_PROMPT.md",
    ...
    relatedAdrs: [
      ...
      "0007-use-central-broker",
      "0011-use-isolated-git-worktrees",
    ],
    relatedPages: ["plans/future-work"],
    tags: ["questions", "conflicts"],
  },
  `
